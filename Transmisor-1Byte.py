...
imagen = Image.open("./audios_imagenes_prueba/arcoiris.png") #importa la imagen
...
max_valor = 255 #determinado por (2^8)-1 por los bits
...
for i, s in frec :
	...
	for k in range(x) :
		datos.append(math.sin((2*math.pi*k*i*ts)+offset)) #valores que va tomando el seno, para generar la señal de audio
